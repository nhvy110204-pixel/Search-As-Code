...
async def planner_node(state: AgentState) -> dict:
    ...
    system_prompt = (
        ...
        "1. High-Level Search (Note: Web search is temporarily commented out for MVP, these fallback to document search):\n"
        ...
        "   - `await sdk.retrieve(query: str, source: str = 'index', limit: int = 10, **kwargs) -> List[SearchHit]`\n"
        "   - `await sdk.fanout(queries: List[str], source: str = 'index', limit_per_query: int = 5) -> List[List[SearchHit]]`\n"
